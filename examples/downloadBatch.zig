...
pub fn main() !void {
    ...
    var tasks = [_]DownloadTask{
        .{ .taskId = 1, .url = sampleUrl, .dest = "downloads/batch_file1.bin" },
        .{ .taskId = 2, .url = sampleUrl, .dest = "downloads/batch_file2.bin" },
        .{ .taskId = 3, .url = sampleUrl, .dest = "downloads/batch_file3.bin" },
    };
